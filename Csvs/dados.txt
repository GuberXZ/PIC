...
Classification -> NaiveBayes - tem maior accuracy para o estimador multinomial (Gaussiano tem melhor recall, mas specificity horrível) - accuracy=0.69.
               -> KNN - overfit à database de treino (precisamos de mais dados) - Best results with 1 neighbors and chebyshev - accuracy=0.92 - erro no minmax dava menor accuracy.
               ...
               -> Best results with depth=10, 0.50 features and 5 estimators, with accuracy=0.76 - SMOTE + Random Forest não "vicia" os dados devido à não duplicação dos dados.
               -> Best results with depth=5, 0.30 features and 5 estimators, with accuracy=0.66 - Random Forest com BalancedBaggingClassifier - demora mais de 5mins.
               -> Best results with lr_type=constant, learning rate=0.9 and 300 max iter, with accuracy=0.6938775510204082 - NeuralNetworks com BalancedBaggingClassifier - demora mais de 5mins.