...
app.layout = html.Div([
    ...
    dbc.Row([
        ...
        dbc.Col([html.Div("Predicted surgical margin",
            ...
            dbc.Row([html.Div([
                dcc.Dropdown(id="modelchoice-dropdown",
                    options=[
...
# Responsive elements: dropdown menu for choosing the model
@app.callback(
    Output('dd-output-container', 'children'),
    [Input("modelchoice-dropdown", "value")],
